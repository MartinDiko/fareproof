...
export function PolicyDashboard() {
  ...
  useEffect(() => {
    ...
    void chrome.runtime.sendMessage({ type: 'RECOVER_SCHEDULER' }).catch(() => undefined).then(load);
