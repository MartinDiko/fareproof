...
import { Bell, Check, Plane, Plus, RotateCcw, Settings, Smartphone } from 'lucide-react';
import { defaultFareSearchPolicies, fareSearchPolicySchema, type FareSearchPolicy } from '@fareproof/core';
import { notificationSettingsSchema, STORAGE_KEYS, type NotificationSettings } from '../shared/state';
...
export function SettingsPage() {
  ...
  useEffect(() => {
    void chrome.storage.local.get([STORAGE_KEYS.policies, STORAGE_KEYS.notificationSettings]).then((result) => {
